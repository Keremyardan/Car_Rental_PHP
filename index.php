...
<head>
    ...
    <link rel="stylesheet" id="switcher-css" href="assets/switcher/css/switcher.css" type="text/css" media="all" />
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
        href="assets/images/favicon-icon/apple-touch-icon-144-precomposed.html">
...
<body>
        ...
        <div class="container">
            <div class="section-header text-center">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam pretium aliquam dui. Donec ac finibus
                    ...
                    accumsan mollis erat, ut viverra mi fermentum a.</p>
            </div>
            <div class="row">
        ...
        <div class="container div_zindex">
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6 col-sm-3">
                    <div class="fun-facts-m">
                        <div class="cell">
                            <h2><i class="fa fa-car" aria-hidden="true"></i>600+</h2>
    ...
    <section class="section-padding testimonial-section parallex-bg">
        ...
        <div class="container div-zindex">
