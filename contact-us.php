                ...
                <div class="col-md-6">
                    ...
                    <div class="contact_form gray-bg">
                        <form method="post">
                            ...
                            <div class="form-group">
                                <label class="control-label">Mail Address<span>*</span></label>
                            ...
                            <div class="form-group">
                                <button class="btn" type="submit" name="send">Send Message <span class="angle_arrow"><i
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="contact_info_m"><a
                                                href="tel:+90-555-555-55-55"><?php echo htmlentities($result->ContactNo) ?></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon_wrap"> <i class="fa fa-envelope-o" aria-hidden="true"></i></div>
                                        <div class="contact_info_m"><a
                                                href="mailto:contact@example.com"><?php echo htmlentities($result->EmailId) ?></a>
                                        </div>
                                    </li>
                                </ul>
